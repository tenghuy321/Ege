  ...
  return (
    <section className='overflow-hidden'>
      ...
      <div className='max-w-7xl mx-auto px-4'>
        ...
        <div className='bg-[#415464F2] px-2 xl:px-10 py-6'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <motion.div variants={fadeIn('right', 0.2)} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='text-[20px] sm:text-[40px] lg:text-[50px] text-[#fff] font-[600] leading-none'>
              <h1 className='text-[#A4CA62]'>EGE Cambodia Energy </h1>
              <p>Solutions.</p>
            </motion.div>
            <div className='flex flex-row space-x-2 items-center justify-end'>
              <motion.div variants={fadeIn('left', 0.3)} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='w-full md:w-[200px] h-[150px] lg:h-[200px] pt-2 px-1 lg:pl-2 lg:pr-10 bg-[#A4CA62] font-[700] leading-none text-[#415464]'>
                <p className='text-[12px] lg:text-[20px]'>Founded in</p>
                <p className='text-[30px] lg:text-[50px]'>2019</p>
              </motion.div>
              <motion.div variants={fadeIn('left', 0.4)} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='w-full md:w-[200px] h-[150px] lg:h-[200px] pt-2 pb-20 px-2 lg:pl-2 lg:pr-10 font-[400] text-[10px] lg:text-[15px] text-[#ffffff] bg-[#00AFD7]'>
                <p>our</p>
              ...
              <motion.div variants={fadeIn('left', 0.5)} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='w-full md:w-[200px] h-[150px] lg:h-[200px] pt-2 pb-20 px-2 lg:pl-2 lg:pr-10 font-[400] text-[10px] md:text-[11px] text-[#ffffff] bg-[#FF5900]'>
                <p>As we continue to grow, we have extended our footprint, not just within Phnom Penh but all over the country.</p>
              </motion.div>
            </div>
          </div>
          <motion.div variants={fadeIn('right', 0.3)} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='flex flex-col space-y-2 pt-3 text-[#ffffff] text-[12px] md:text-[15px]'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 px-4 py-10'>
          {/* vision */}
          <motion.div id='vision' variants={fadeIn('right', 0.3)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='flex flex-col md:flex-row items-start space-x-0 md:space-x-5 lg:space-x-10 text-[13px] lg:text-[15px] text-[#415464] p-5 lg:p-10'>
          ...
          {/* mission */}
          <motion.div id='mission' variants={fadeIn('left', 0.3)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='bg-[#415464]'>
        ...
        <div id='core_values' className='px-8 text-[#415464]'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 py-2'>
            <motion.div variants={fadeIn('up', 0.4)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='text-[12px] md:text-[14px] text-[#415464] hover:text-[#A4CA62] hover:bg-[#415464] p-4'>
            ...
            <motion.div variants={fadeIn('up', 0.5)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='text-[12px] md:text-[14px] text-[#415464] hover:text-[#A4CA62] hover:bg-[#415464] p-4'>
            ...
            <motion.div variants={fadeIn('up', 0.6)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='text-[12px] md:text-[14px] text-[#415464] hover:text-[#A4CA62] hover:bg-[#415464] p-4'>
      ...
      <div id='history' className='w-full relative min-h-screen my-10'>
        ...
        <div className='absolute inset-0 w-full h-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 items-center md:items-start justify-center p-4 md:px-10 py-10'>
          <div className='flex flex-col text-center md:text-start space-y-1 md:space-y-20'>
            <motion.h1 variants={fadeIn('right', 0.3)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='w-full md:max-w-[300px] text-[30px] md:text-[40px] xl:text-[60px] font-bold text-[#ffffff] leading-none'>
              Our History
            </motion.h1>
            <motion.p variants={fadeIn('right', 0.4)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='w-full md:max-w-[300px] text-[20px] md:text-[30px] xl:text-[40px] font-bold text-[#ffffff]'>
      ...
      <div id='management_team' className='max-w-7xl mx-auto px-4'>
        <motion.h1 variants={fadeIn('right', 0.3)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='text-[30px] md:text-[40px] lg:text-[50px] text-[#415464] font-[700] my-10'>Our Management Team</motion.h1>
        <div className='hidden md:grid grid-cols-3 gap-10 lg:gap-20'>
          <motion.div variants={fadeIn('up', 0.3)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='text-center md:text-[15px] lg:text-[20px] font-[700] text-[#415464]'>
          ...
          <motion.div variants={fadeIn('up', 0.4)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='text-center md:text-[15px] lg:text-[20px] font-[700] text-[#415464]'>
          ...
          <motion.div variants={fadeIn('up', 0.5)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='text-center md:text-[15px] lg:text-[20px] font-[700] text-[#415464]'>
      ...
      <div className='hidden md:grid grid-cols-4 gap-6 px-4 items-center max-w-7xl mx-auto my-20'>
        <motion.div variants={fadeIn('right', 0.3)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='md:col-span-2'>
          <img src={cert1} alt="" />
        </motion.div>
      ...
      <div className='max-w-7xl mx-auto px-4'>
        ...
        <div id='certificate' className='hidden md:grid grid-cols-5 gap-10'>
          {awards.map((award, index) => (
            <motion.div variants={fadeIn('up', 0.3)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} key={index}>
        ...
        <div className='hidden md:grid grid-cols-4 gap-4 mt-40'>
          <motion.img variants={fadeIn('right', 0.4)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} src={awards6} alt="" />
          <motion.img variants={fadeIn('right', 0.3)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} src={awards7} alt="" />
          <motion.img variants={fadeIn('left', 0.3)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} src={awards8} alt="" />
          <motion.img variants={fadeIn('left', 0.4)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} src={awards9} alt="" />
        </div>
      ...
      <div className='w-full mx-auto h-[50vh] md:h-screen relative'>
        ...
        <div className='absolute right-[50%] translate-x-1/2 md:-translate-x-0 md:right-[100px] top-[50px] xl:top-[100px] text-[#ffffff]'>
          <hr className='h-[5px] bg-[#A4CA62] border-none w-[300px]' />
          <motion.div variants={fadeIn('left', 0.4)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='max-w-[500px] h-[150px] md:h-[180px] xl:h-[200px] bg-black/80 py-4 pl-8 pr-20 leading-none'>
      ...
      <div className='w-full mx-auto h-[50vh] sm:h-[80vh] md:h-full relative mt-4'>
        ...
        <div className='absolute w-full md:w-[700px] px-4 top-[20px] md:top-[100px] left-1/2 -translate-x-1/2 text-center text-[#000000] text-[12px] md:text-[16px] lg:text-[20px]'>
          <motion.h1 variants={fadeIn('up', 0.3)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='text-[30px] md:text-[50px] lg:text-[60px] text-[#415464] font-[700]'>Future Goal</motion.h1>
          <motion.p variants={fadeIn('up', 0.4)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }}>Our future objective is to extend our solar footprint into new territories,
            speciﬁcally targeting expansion into Southeast Asia region.</motion.p>
        </div>
      </div>

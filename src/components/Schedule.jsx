            ...
            <div className="w-full min-h-screen bg-[#D9ECEE]">
                <div className="max-w-5xl mx-auto py-10 md:py-20">
                    <div className="px-5 2xl:px-0">
                        <h1 className="text-[#A4CA62] text-[20px] sm:text-[25px] md:text-[30px] font-[700]">Schedule a Consultation</h1>
                    ...
                    <form action=""
                        ...
                        <div>
                            <label htmlFor="date" className="block text-sm font-medium text-gray-700">Date <span className="text-red-800">*</span></label>
